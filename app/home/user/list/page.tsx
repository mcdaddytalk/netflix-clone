...
export default async function Watchlist() {
  ...
  return (
    <>
        <h1 className="text-white text-4xl sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 px-5 sm:px-0 mt-10 gap-6">
            Your Watchlist
        </h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-5 sm:px-0 mt-10">
            {data.length > 0
              ? (data?.map((movie) => (
                ...
                <h2>You do not have any items in your watchlist</h2>
              )
            }
        </div>
    </>
